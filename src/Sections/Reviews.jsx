...
const Reviews = () => {
  return (
    <section className='bg-lightgray py-10 lg:py-150  overflow-x-hidden'>
      <Container>
        <Flex className={`flex-col lg:flex-row items-center text-center lg:text-start w-full lg:w-auto lg:justify-between gap-9`}>
          ...
          <Flex className={`flex-col md:flex-row lg:flex-row mt-6 lg:mt-0 items-center w-full lg:w-auto gap-14 lg:gap-6 md:justify-center lg:justify-between w-auto w-3/5`}>
