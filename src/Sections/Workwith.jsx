...
const Workwith = () => {
  return (
    <section className='bg-lightgray py-10 lg:py-100 overflow-x-hidden'>
      ...
      <Container>
        <Flex className={`w-full sm:px-4 lg:px-0 lg:auto flex-col items-center md:flex-row lg:flex-row  md:flex-wrap md:justify-center sm:justify-center lg:justify-start  gap-9`}>
