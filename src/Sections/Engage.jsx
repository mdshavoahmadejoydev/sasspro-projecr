  ...
  return (
    <section className='overflow-x-hidden'>
      <Container className={`pt-10 lg:pt-28 pb-10 lg:pb-70`}>
        <Flex className={`flex-col w-full lg:w-auto lg:flex-row items-center sm:items-center md:items-center lg:justify-center lg:gap-10 lg:items-center`}>
          <Img src={Engageimg} alt={`engage graph`} className={`w-4/5 sm:w-[70%] md:w-[70%] lg:w-544 lg:h-498`} />
          <div className='w-full px-4 lg:px-0 text-center lg:text-start lg:w-auto'>
